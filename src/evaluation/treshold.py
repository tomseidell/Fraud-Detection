...
"""
In this file we will perform threshold tuning. With the given problem (Fraud detection of payments), we especially focused
...
thresholds = [0.0125, 0.025, 0.05, 0.075, 0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25, 0.275, 0.3, 0.325, 0.35, 0.375, 0.4, 0.425, 0.45, 0.475, 0.5]
results = []
for t in thresholds:
    metrics = EvaluationMetrics(y=y_test, y_pred=y_pred_test, threshold=t)
    results.append({
        "threshold": t,
...
# print overview for all thresholds
